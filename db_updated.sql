...
CREATE TABLE IF NOT EXISTS `ads` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='add banner' AUTO_INCREMENT=20 ;
...
(1, 'CU c@nteen', 'CU c@nteen', 'Course project for CSCI3100 designed by group5', 'All rights reserved by Group 5', '', 'localhost', '123456789', '123456@qq.com');
